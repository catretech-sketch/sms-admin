/* ============================================================
   SchoolMate — Icon set (stroke, 24px grid). Ported from icons.jsx.
   ============================================================ */
...
ICONS.chevron = ICONS.chevDown
ICONS.dollar = ICONS.rupee
ICONS.plusCircle = ICONS.plus
...
export function Icon({ name, size = 18, stroke = 2, className, style, fill = 'none' }: IconProps) {
  const d = ICONS[name] ?? 'M12 12h.01' // fallback dot
  return (
